const config = {
  metadata: {
    ...
    keywords:
      'next.js 15, next.js-15-template, next.js-15-boilerplate, react.js 19, react.js-19-template, react.js-19-boilerplate, typescript, better-auth, drizzle, shadcn, shadcn/ui, tailwindcss 4, eslint, prettier, husky, commitlint, lint-staged'
  },
  server: {
    host: 'localhost',
    port: 3000
